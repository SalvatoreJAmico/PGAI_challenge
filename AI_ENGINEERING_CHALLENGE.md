...
**Cost note:** Depending on which APIs and LLMs you use, there will be usage fees. Successful submissions typically cost less than $20 total in API and telephony charges. We reimburse up to $20. Just send us your receipts with your submission.

## Setup

Create a test account at pgai.us/athena — this gives you context on how our product works and what patients experience. Do not call the number shown on the confirmation screen.
...
Fill out the Pretty Good AI - AI Engineer Submission form and submit.

Make sure these are ALL included:

- GitHub repository link (MUST BE PUBLIC)
- 2 Loom videos — 1) walkthrough of project & 2) AI debugging video (MUST BE PUBLIC)
